                    ...
                    <div className="flex justify-between text-white flex-col  p-5 relative z-[2] h-full">
                        <div>
                            {data.status === "Upcoming" ? (
                                <div
                                    className="bg-neutral-700 w-max text-white px-3 py-1 rounded-full flex items-center gap-3 text-xs">
                        ...
                        <div className="flex items-center justify-between">
                            <div
                                className="registrations flex gap-2 items-center text-sm bg-neutral-700 px-4 py-1 rounded-full text-white">
