...
export default function SupplierComponent({
    ...
    return (
        <>
            <div
                className="supplier border-1 border-neutral-50 shadow-sm shadow-neutral-50 rounded-lg w-full flex flex-col">
                <div className="px-5 py-4 flex gap-2 justify-between border-b-1 border-neutral-50">
                    <div className="flex gap-4 items-center">
                        <div
                            className="icon border-1 border-neutral-200 shadow-sm shadow-neutral-200 rounded-full overflow-hidden h-[40px] w-[40px]">
