import { Check, ChevronLeft, PersonStanding, X } from "lucide-react";
            ...
            <div>
              ...
              <AnimatePresence>
                {pwCheck.active && (
                  ...
                  >
                    <div className="st-bar  h-[5px] border-1 border-neutral-100 overflow-hidden w-full rounded-lg mt-2 flex justify-start">
                      <div
