...
import {ArrowLeft, ArrowRight, Check, ChevronDown, ChevronUp, DoorOpen, X,} from "lucide-react";
...
export default function OrdinaryEvent() {
    ...
    const handleStepIncrementation = async () => {
        switch (step) {
            ...
            case 3: {
                if (
                    !timesheets.startT.value ||
                    !timesheets.endT.value ||
                    timesheets.inc.value < 1 ||
                    timesheets.lim.value < 1
                )
                    return;
            ...
            case 5: {
                ...
                const payload = {
                    ...
                    tsEndT: getUnix(time.date.value, timesheets.endT.value),
                ...
                try {
                    ...
                    modal.show({
                        ...
                        content: "BizMatch event has been uploaded.",
                    ...
                    modal.show({
                        icon: <X/>,
                        title: "Upload fail.",
                        content: "BizMatch event has not been uploaded.",
            ...
            <>
                <main className="min-h-screen w-full bg-[#f5f6fb] inter pb-5">
                    ...
                    <section>
                        <div className="eventra-container-narrow pt-5">
                            ...
                            <div className="steps flex gap-3 items-center mt-5 text-sm">
                                ...
                                <div className={step === 5 ? stepActive : stepInactive}>
                                    <p>Summary</p>
                                </div>
                            </div>
                        </div>
                    ...
                    {step === 3 && (
                        <Timesheets
                            data={timesheets}
                            onDataChange={setTimesheets}
                            dateReference={time.date.value}
                            offset={time.offset.value}
                        />
                    )}
                    {step === 4 && (
