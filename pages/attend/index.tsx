              ...
              <div className="w-full">
                ...
                <div className="border border-indigo-900">
                  ...
                  <div className="flex bg-gray-100">
                    ...
                    <div className="w-3/4 p-4">
                      <div className="text-indigo-800 font-semibold">
                        Panel Discussion – Unlocking ASEAN’s Potential: Growth &
                        Market Expansion in Lauric Oils & Downstream Sectors
                      </div>

                      <div className="text-sm">
                        Moderator: Datuk Saw Lee Chyan, Chairman, Malaysian
                        Oleochemical Manufacturers Group
                      </div>
                      <div className="text-sm">
                        Panelist 1: Engr. Marco C. Reyes, Chairman, United
                        Coconut Associations of the Philippines Inc.
                      </div>
                      <div className="text-sm">
                        Panelist 2: Mr. Dean Lao Jr, President/CEO, Chemrez
                        Technologies Inc.
                      </div>
                      <div className="text-sm">
                  ...
                  <div className="flex bg-gray-100">
                    ...
                    <div className="w-3/4 p-4">
                      <div className="text-indigo-800 font-semibold">
                        Paper 4: Nutrients from Palm Oil: Health Benefits and
                        its Applications
                      </div>
                  ...
                  <div className="flex bg-gray-100">
                    ...
                    <div className="w-3/4 p-4">
                      <div className="text-indigo-800 font-semibold">
                        Paper 5: Advancement in Frying Applications with
                  ...
                  <div className="flex bg-gray-100">
                    ...
                    <div className="w-3/4 p-4">
                      <div className="text-indigo-800 font-semibold">
                        Paper 6: Deep Dive in the Philippines’ Beauty and
                        Personal Care Market and its Growth Potential
                      </div>
                  ...
                  <div className="flex bg-gray-100">
                    ...
                    <div className="w-3/4 p-4">
                      <div className="text-indigo-800 font-semibold">
                        Paper 7: What’s Driving Demand for Palm-Based Fatty
                        Alcohols?
                      </div>
