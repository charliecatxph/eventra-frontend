        ...
        switch (step) {
            ...
            case 3: {
                ...
                try {
                    ...
                    console.log("Upload fail.", e.response.data.msg);
        ...
        <>
            ...
            <div className="hidden">
                ...
                <footer className="px-5 fixed w-full bottom-[20px] geist">
                    <button
                        className="text-sm bg-emerald-700 w-full py-2.5 font-[500] text-emerald-100 rounded-lg mt-[100px]">
                        Start
                    </button>
            ...
            >
                <button
                    className="hover:bg-emerald-700 bg-emerald-800 text-emerald-100 rounded-lg w-full py-2 text-sm mb-3">
