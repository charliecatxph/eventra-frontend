...
import {ArrowLeftRight, ArrowUpRight, ChevronDown, ChevronUp,} from "lucide-react";
                                        ...
                                        >
                                            ...
                                            <div className="flex items-end flex-col justify-center">
                                                <div className="status p-1.5 text-sm flex gap-1 items-center">
                                                    <div
                                                        className="type border-1 border-neutral-100 shadow-sm shadow-neutral-50 text-xs  px-3 py-1 text-black rounded-full w-max flex gap-2 items-center">
                                                        {d.type === "Ordinary" ? (
