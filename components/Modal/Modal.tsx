    ...
    <>
      ...
      {color === "emerald" && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="modal-container fixed top-0 left-0 h-full w-full bg-slate-900/80 z-[9999] grid place-content-center inter"
        >
          <motion.div
            initial={{ scale: 0.9, opacity: 0 }}
            animate={{
            ...
            exit={{ scale: 0.9, opacity: 0 }}
            key={2}
            className="modal bg-white rounded-2xl w-[500px] overflow-hidden"
          >
            <div className="flex items-center gap-5  px-7 py-5 min-h-[170px]">
              <div className="">
              ...
              <div className="">
                <h1 className="font-[500] mt-1">{title}</h1>
                <p className="text-sm mt-2 text-neutral-800">{content}</p>
              </div>
            </div>
            <div className="flex justify-end items-center bg-neutral-50 px-4 py-2">
              <div className="flex gap-2 text-sm">
