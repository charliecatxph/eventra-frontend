  ...
  const renderPageNums = () => {
    ...
    if (net <= 4) {
      ...
      if (currPage > 4 && currPage !== net) {
        ...
        items.push(
          <div className="hover:bg-neutral-900 bg-black text-white font-[600] w-[40px] h-[40px] grid place-content-center text-sm border-1 border-neutral-200 rounded-lg">
            {currPage}
          </div>
        );
        items.push(
